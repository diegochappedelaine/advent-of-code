...
export const getNeighbors = ([row, column]: Position, [mapWidth, mapHeight]: Dimension): Array<Position> => {
  ...
  return [top, right, bottom, left].filter(Boolean) as Array<Position>;
};

export const generateMap = (instructions: string[], withMultipleStart = false) => {
